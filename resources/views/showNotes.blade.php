        ...
        <div class="container-fluid">
            ...
            <div class="box_general padding_bottom box_custom" style="height: 84vh;">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <p
                                style="border-radius: 20px; color: white; border:none; padding-left: 20px; padding-right: 20px; font-size: 16px; text-align: justify; margin-top: 20px;">
                                {{ $note->desc }}</p>
                        </div>
                    </div>
                </div>
                ...
                <a href="{{ route('editNotes', [$note->id]) }}">
                    <button type="button" class="btn btn-success btn_edit">Edit</button>
                </a>
            </div>
            <!-- /.container-fluid-->
        </div>
